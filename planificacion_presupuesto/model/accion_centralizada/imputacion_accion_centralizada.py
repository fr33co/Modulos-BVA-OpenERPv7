...
class imputacion_accion_centralizada(osv.Model):

	_name = "imputacion.accion.centralizada"
	...
	_columns = {
		'imputacion_acc_ids':fields.many2one('accion.centralizada', 'imputacion_acciones', ondelete='cascade', select=False),
