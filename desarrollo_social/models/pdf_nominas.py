...
#CLASE PARA LA NÓMINA RESUMEN DE CONCEPTOS POR BANCO----------------------------------------------------
class PDF(FPDF):
	...
	def header(self):
		...
		self.image('../img/logo_bva2.jpg',10,10,50)
	...
	def footer(self):
		...
		#Numero de pagina
		self.cell(190,-500,'Pág: '.decode("UTF-8")+str(self.page_no()),0,0,'R') #Primer y segundo parametro indican posición de número de página
...
#CLASE PARA EL RESUMEN DE NÓMINA------------------------------------------------------------------------
class PDF2(FPDF):
...
#CLASE PARA LA NÓMINA DETALLADO POR BANCO---------------------------------------------------------------
class PDF3(FPDF):
