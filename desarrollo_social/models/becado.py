...
class Becado(osv.Model):
	...
	_columns = {
		...
		'direccion' : fields.text(string="Dirección", size = 256, required=False),
		'grado_instruccion': fields.many2one("becados.gradoinstruccion", "Grado de Instrucción", required = False),
