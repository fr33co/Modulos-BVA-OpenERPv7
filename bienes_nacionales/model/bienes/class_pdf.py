...
class PDF(FPDF):
	...
	def header(self):
		...
		self.image('openerp/addons/producto_bva/img/001.jpg',10,5,25)
		self.image('openerp/addons/producto_bva/img/002.jpg',223,8,50)
	...
	def footer(self):
		...
		#Numero de pagina
		#self.cell(0,-50,'Hoja N°: '.decode("UTF-8")+str(self.page_no()),0,0,'R') 
...
class PDF2(FPDF):
	...
	def header(self):
		...
		self.image('openerp/addons/producto_bva/img/logo_bva2.jpg',8,7,40)
		#Calcular ancho del texto (title) y establecer posición
		#w=self.get_string_width(title)+6
		#self.set_x((210-w)/2)
		#Colores del marco, fondo y texto
...
class PDF3(FPDF):
	...
	def header(self):
		...
		self.image('openerp/addons/producto_bva/img/logo_bva2.jpg',20,15,50)
		#Calcular ancho del texto (title) y establecer posición
		#w=self.get_string_width(title)+6
		#self.set_x((210-w)/2)
		#Colores del marco, fondo y texto
...
class PDF4(FPDF):
	...
	def header(self):
		...
		self.image('openerp/addons/producto_bva/img/img_top.jpg',20,10,178)
		#Calcular ancho del texto (title) y establecer posición
		#w=self.get_string_width(title)+6
		#self.set_x((210-w)/2)
		#Colores del marco, fondo y texto
...
class PDF5(FPDF):
	...
	def header(self):
		...
		self.image('openerp/addons/producto_bva/img/logo_bva2.jpg',13,10,50)
		#Calcular ancho del texto (title) y establecer posición
		#w=self.get_string_width(title)+6
		#self.set_x((210-w)/2)
		#Colores del marco, fondo y texto
